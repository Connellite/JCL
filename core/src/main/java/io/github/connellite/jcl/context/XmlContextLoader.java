...
import io.github.connellite.jcl.AbstractClassLoader;
import io.github.connellite.jcl.JarClassLoader;
import io.github.connellite.jcl.ProxyClassLoader;
import io.github.connellite.jcl.exception.JclContextException;
import io.github.connellite.jcl.utils.PathResolver;
...
public class XmlContextLoader implements JclContextLoader {
    ...
    private static final String JCL_CONTEXT_SCHEMA = "io/github/connellite/jcl/context/jcl-context.xsd";
     ...
     * 
     * @see io.github.connellite.jcl.context.JclContextLoader#loadContext()
     */ 
     ...
     * Unloads the context
     * 
     * @see io.github.connellite.jcl.context.JclContextLoader#unloadContext()
     */ 
