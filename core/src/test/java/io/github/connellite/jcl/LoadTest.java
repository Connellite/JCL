...
import io.github.connellite.jcl.context.JclContextLoader;
...
import io.github.connellite.jcl.test.TestInterface;
...
public class LoadTest extends TestCase {
    ...
    public void testInterfaceCast() {
        ...
        Object testObj = factory.create( jc, "io.github.connellite.jcl.test.Test" );
    ...
    public void testAutoProxy() {
        ...
        TestInterface test = (TestInterface) factory.create( jc, "io.github.connellite.jcl.test.Test" );
    ...
    public void testUnloading() throws IOException, InstantiationException, IllegalAccessException,
        ...
        Object testObj = null;
        jc.loadClass( "io.github.connellite.jcl.test.Test" );
    ...
    public void testEnabledFlag() {
        ...
        String cls = "io.github.connellite.jcl.test.Test";
        try {
            jc.loadClass( cls );
    ...
    public void testOsgiBootLoading() throws ClassNotFoundException {
        ...
        obl.setBootDelagation( new String[] { "io.github.connellite.jcl.test.*" } );

        assertAppClassLoader( jc.loadClass( "io.github.connellite.jcl.test.Test" ).getClassLoader() );
    }
    ...
    public void testXmlContextLoader() throws ClassNotFoundException {
        ...
        JclContext.get( "jcl1" ).loadClass( "io.github.connellite.jcl.test.Test" );

        try {
            JclContext.get( "jcl2" ).loadClass( "io.github.connellite.jcl.test.Test" );
            throw new AssertionFailedError( "expected ClassNotFoundException" );
        } catch (ClassNotFoundException e) {
            // expected
        }

        assertAppClassLoader(
                JclContext.get( "jcl3" ).loadClass( "io.github.connellite.jcl.test.Test" ).getClassLoader() );
    }
    ...
    private static void assertAppClassLoader(ClassLoader classLoader) {
        assertTrue( classLoader.getClass().getName().endsWith( "AppClassLoader" ) );
    }
}
